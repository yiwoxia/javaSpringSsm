	...
	<div class="container" >
		<div class="row">
			...
			<div class="col-md-10">
				...
				<!-- 添加班级 开始 -->
				<form style="margin-top: 10px;" action="${pageContext.request.contextPath }/banji/update.action" method="post" >
					<div class="form-group">
						   <label for="exampleInputEmail1">id</label>
						   <input type="text" name="id" value="${banji.id }" readonly="readonly" class="form-control" id="exampleInputEmail1" placeholder="ID">
					  </div>
					<div class="form-group">
					   <label for="exampleInputEmail1">班级</label>
					   <input type="text" name="bname" value="${banji.name }" class="form-control" id="exampleInputEmail1" placeholder="班级名">
				  </div>
