			...
			<div class="col-md-10">
				...
				<form style="margin-top: 10px;" action="${pageContext.request.contextPath }/course/update.action" method="post" >
					<div class="form-group">
					   ...
					   <input type="text" name="cid" value="${course.cid }" readonly="readonly" class="form-control" id="exampleInputEmail1" >
				  </div>
					<div class="form-group">
					   <label for="exampleInputEmail1">课程</label>
					   <input type="text" name="cname" value="${course.cname }" class="form-control" id="exampleInputEmail1" >
				  </div>
