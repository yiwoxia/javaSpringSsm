			...
			<div class="col-md-10">
				...
				<form style="margin-top: 10px;" action="${pageContext.request.contextPath }/banji/addBanJi.action" method="post" >
					<div class="form-group">
						   ...
						   <input type="text" name="bid" value="${banji.bid }" readonly="readonly" class="form-control" id="exampleInputEmail1" placeholder="姓名">
					  </div>
					<div class="form-group">
					   <label for="exampleInputEmail1">班级</label>
					   <input type="text" name="bname" value="${banji.bname }" class="form-control" id="exampleInputEmail1" placeholder="姓名">
				  </div>
