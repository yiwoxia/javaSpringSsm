		...
		<div class="row">
			...
			<div class="col-md-2" >
				<ul class="nav nav-pills nav-stacked">
					...
					<li role="presentation" class="active"><a href="#">修改课程</a></li>
				</ul>
			</div>
			...
			<div class="col-md-10">
				...
				<form style="margin-top: 10px;" action="${pageContext.request.contextPath }/course/update.action" method="post" >
					<div class="form-group">
					   <label for="exampleInputEmail1">课程序号</label>
					   <input type="text" name="cid" value="${coures.cid }" readonly="readonly" class="form-control" id="exampleInputEmail1" >
				  </div>
					<div class="form-group">
					   <label for="exampleInputEmail1">课程</label>
					   <input type="text" name="cname" value="${coures.cname }" class="form-control" id="exampleInputEmail1" >
				  </div>
					<div class="form-group">
					   <label for="exampleInputEmail1">授课老师</label>
					   <input type="text" name="teacher" value="${coures.teacher }" class="form-control" id="exampleInputEmail1" >
				  </div>
